...
export default class CognitoAuth {
  ...
  getFQDNURI(domainPath) {
    ...
    const uri = this.getCognitoConstants().DOMAIN_SCHEME.concat(this.getCognitoConstants().COLONDOUBLESLASH, this.getAppWebDomain(), this.getCognitoConstants().SLASH, domainPath, //this.getCognitoConstants().DOMAIN_PATH_SIGNIN,
